...
const main = async () => {
  ...
  //https://etherscan.io/address/0x65c816077c29b557bee980ae3cc2dce80204a0c5/advanced#code
  //oracle for mainnet
  ...
  const Borrow = await borrow.deploy(
    ...
    "0x65F19195e488B9C1A1Ac08ca115f197C992bC776"
  );
  await Borrow.deployed();
  await Borrow.createAssetForCtoken(
    "0x208f73527727bcb2d9ca9ba047e3979559eb08cc",
    "0x2073d38198511F5Ed8d893AB43A03bFDEae0b1A5"
  );
  await Borrow.createAssetForToken(
    "0x2073d38198511F5Ed8d893AB43A03bFDEae0b1A5",
    "0x208f73527727bcb2d9ca9ba047e3979559eb08cc"
  );
  await Borrow.enterToMarket("0x2073d38198511F5Ed8d893AB43A03bFDEae0b1A5");
